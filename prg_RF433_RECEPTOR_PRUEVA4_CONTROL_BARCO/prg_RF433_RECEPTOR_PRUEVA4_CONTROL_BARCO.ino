...
#define des_LAT 44.00094 //  latitud  destino
#define des_LNG  25.00024 //  longitud destino  elegido
     //   DESTINO.

//VARIABLES DE  LED
#define LEDROJO 0   // reemplaza ocurrencia de LEDROJO por el numero 2
...
void setup()
{
    pinMode(LEDROJO, OUTPUT); // pin 0 como salida  LED
